...
pub fn map_surrounding_ground_bitmask_to_atlas_index(bitmask: u8) -> usize {
    let indices = [
        ...
        15, 17, 13, 14, 13, 14, 15, 16, 15, 17, 
        18, 19, 18, 19, 20, 21, 20, 22, 18, 19, 
        18, 19, 23, 24, 23, 25, 13, 14, 13, 14, /* 100 */
        15, 16, 15, 17, 13, 14, 13, 14, 15, 16, 
        15, 17, 26, 27, 26, 27, 28, 29, 28, 30, 
        26, 27, 26, 27, 31, 32, 31, 33, 0, 1, 
        ...
        0, 1, 2, 3, 49, 4, 5, 6, 5, 6, 
        7, 8, 50, 9, 5, 6, 5, 6, 10, 11, 
        51, 12, 52, 34, 52, 34, 15, 35, 15, 36, /* 200 */ 
        52, 34, 52, 34, 15, 35, 15, 36, 18, 37, 
        18, 37, 20, 38, 20, 39, 18, 37, 18, 37, 
        23, 40, 23, 41, 52, 34, 52, 34, 15, 35, 
        15, 36, 52, 34, 52, 34, 15, 35, 15, 36, 
        26, 42, 26, 42, 28, 43, 28, 44, 26, 42, 
        26, 42, 31, 45, 31, 46];
