...
use common::{animated_sprite::{animate_sprites, check_animate_on_touch}, checkpoint::check_checkpoint_reached, death::despawn_death_marked, physics::{bouncy::check_bouncy_collisions, gravity::simulate_gravity}, shake::shake, states::StatesPlugin};
use game::GamePlugin;
...
fn main() {
    ...
    App::new()
        ...
        .add_systems(Update, (check_bouncy_collisions, check_animate_on_touch, update_player_airborn_look_state, update_player_grounded_look_state, update_player_look_direction))
        .run();
}
