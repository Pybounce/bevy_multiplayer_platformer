...
use common::{checkpoint::check_checkpoint_reached, death::despawn_death_marked, shake::shake, states::StatesPlugin, worldspace_text::{setup_ws_text, update_ws_text}};
use game::GamePlugin;
...
fn main() {
    ...
    App::new()
        ...
        .add_systems(Update, (simulate_gravity, check_checkpoint_reached, setup_ws_text, update_ws_text))
        .run();
}
