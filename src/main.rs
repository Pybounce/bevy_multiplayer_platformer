...
fn main() {
    ...
    App::new()
        ...
        .add_systems(Update, (shatter_glass, tween_colours, player_death_particles, refresh_editor_renderer, draw_editor, update_mouse_data))
