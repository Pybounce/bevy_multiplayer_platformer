...
use camera::{camera_shake_on_death, move_camera, spawn_camera};
...
fn main() {
    ...
    App::new()
        ...
        .add_systems(Update, (camera_shake_on_death, move_camera, close_on_esc, spawn_new_players, remove_disconnected_players))
